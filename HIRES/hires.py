...
"""
This python script runs several numerical simulations with the HIRES model 
(described in include/IVP_ODE_HIRES.h) by invoking VSIIE andd IIE solvers with different 
...
#************************************************************************************   
# Parameters to run the experiments for HIRES model. 
# You can modify them to run different scenarios.  
#************************************************************************************
Problem=5
IVP_name="HIRES"
Neqn=8
