...
"""
This python script runs several numerical simulations with the Ignition combustion model 
...
alpha_array=[
    ...
    [0.4, 0.4, 0.4, 0.6, 0.6, 0.6], #order 2
    [0.3, 0.3, 0.4, 0.4, 0.4, 0.4], #order 3 
    [0.3, 0.3, 0.3, 0.3, 0.3, 0.3]  #order 4
]
